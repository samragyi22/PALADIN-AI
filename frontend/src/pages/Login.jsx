      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in relative z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Sign in to access your Enterprise AI Analyst Console
          </p>
        </div>
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-slate-950/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full btn-tactile flex items-center justify-center gap-2 py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl shadow-lg shadow-indigo-600/25 text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
              {isSubmitting ? (
                <>
